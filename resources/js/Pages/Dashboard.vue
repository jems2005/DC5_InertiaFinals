      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl p-8 border-l-4 border-indigo-600 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              href="/requests"
              class="group relative flex items-center justify-center px-8 py-4 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 hover:shadow-xl font-bold text-base"
            >
            ...
            <Link
              href="/inventory"
              class="group relative flex items-center justify-center px-8 py-4 bg-gradient-to-br from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-300 transform hover:scale-105 hover:shadow-xl font-bold text-base"
            >
            ...
            <Link
              ...
              class="group relative flex items-center justify-center px-8 py-4 bg-gradient-to-br from-indigo-600 to-indigo-700 text-white rounded-xl hover:from-indigo-700 hover:to-indigo-800 transition-all duration-300 transform hover:scale-105 hover:shadow-xl font-bold text-base"
            >
